...
export default function Settings() {
  ...
  const getLaunchChecklist = (): LaunchCheck[] => {
    ...
    const asyncDefaults: LaunchCheck[] = [
      ...
      { key: 'approvedBuyerAppearsGlobalDb', name: 'Approved buyer appears in Global Buyer DB', status: 'pass', label: 'Ready', detail: 'After approval, the Global Buyer DB reloads from scoped Supabase buyers.' },
