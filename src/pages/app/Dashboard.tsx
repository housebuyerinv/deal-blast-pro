  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
        ...
        {!ownerAdminToolsVisible && (
          <div className="card p-4 lg:col-span-3 border border-[#252A38] bg-[#0F111A] flex flex-col justify-between min-h-[112px]">
            <div className="text-xs uppercase tracking-[1.5px] text-[#8B92A3]">Get Started</div>
            <div className="text-sm text-[#C5CAD6] mt-2">Add a deal or import buyers to start matching opportunities.</div>
